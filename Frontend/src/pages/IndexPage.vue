  ...
  <q-page>
    <div class="column fixed-center">
      ...
      <div class="row justify-center no-wrap" style="width: 205px;">
        <q-btn class="col my-font bg-teal-3 q-ma-md" v-on:click="joinGame = !joinGame" icon="group_add" label="Join Game"
          text-color="black" />
      </div>
    </div>
    <div class="col" style="width: 205px;">
      <transition appear enter-active-class="animated fadeInDown" leave-active-class="animated fadeOut">
        <div v-if="joinGame " class="row no-wrap">
          <q-input class="col-10 q-mt-md q-ml-md q-mr-sm" label="Game-ID" label-color="grey-9" dense v-model="gameID" style="width: 130px;"></q-input>
          <q-btn class="col-2 q-mt-md" color="teal-3" icon="arrow_right" text-color="black" style="height: 30px;"/>
        </div>
